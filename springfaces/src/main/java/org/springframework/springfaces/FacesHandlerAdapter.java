...
public class FacesHandlerAdapter extends WebContentGenerator implements HandlerAdapter, Ordered, BeanFactoryAware,
		ServletConfigAware, ApplicationListener<ContextRefreshedEvent> {

	private BeanFactory beanFactory;

	private boolean detectannotationMethodHandlerAdapter = true;
	...
	public ModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		//			if (pathInfo.startsWith("/WEB-INF/") || pathInfo.equals("/WEB-INF") || pathInfo.startsWith("/META-INF/")
	...
	protected void initAnnotationMethodHandlerAdapter(ApplicationContext context) {
		if (this.detectannotationMethodHandlerAdapter && this.annotationMethodHandlerAdapter == null) {
