...
class ResourcesBeanDefinitionParser extends AbstractBeanDefinitionParser {
	...
	protected AbstractBeanDefinition parseInternal(Element element, ParserContext parserContext) {
		...
		if (!helper.getParserContext().getRegistry().containsBeanDefinition(HttpRequestHandlerAdapter.class.getName())) {
			helper.register(HttpRequestHandlerAdapter.class);
		}

		// Register the handler
		RegisteredBeanDefinition resourceHanlder = helper.register(FacesResourceRequestHandler.class);

		// Register the mapping
		Map<String, String> urlMap = new ManagedMap<String, String>();
		urlMap.put("/javax.faces.resource/**", resourceHanlder.getName());
