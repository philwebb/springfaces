...
@PageURL("/navigation/implicitcommandbutton")
public class NavigateImplicitCommandButtonPage extends PageObject {

	public NavigateImplicitCommandButtonPage(WebDriver webDriver) {
		super(webDriver);
	}

	@Override
	protected boolean isCorrectPage(String title) {
		return title.equals("Navigation - Implicit Command Button");
	}
