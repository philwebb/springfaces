...
@PageURL("/exceptionhandler/messagenavigationmapping")
public class MessageNavigationMappingPage extends PageObject {

	public MessageNavigationMappingPage(WebDriver webDriver) {
		super(webDriver);
	}

	@Override
	protected boolean isCorrectPage(String title) {
		return title.equals("Exception Handler - Message Navigation Mapping");
	}

	public MessageNavigationMappingPage click() {
		getWebDriver().findElement(By.id("form:button")).click();
		return newPage(MessageNavigationMappingPage.class);
	}
