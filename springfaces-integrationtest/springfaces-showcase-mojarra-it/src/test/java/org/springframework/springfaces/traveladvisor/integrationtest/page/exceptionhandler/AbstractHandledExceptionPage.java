...
public abstract class AbstractHandledExceptionPage extends PageObject {

	public AbstractHandledExceptionPage(WebDriver webDriver) {
		super(webDriver);
	}

	public OutcomePage click() {
		getWebDriver().findElement(By.id("form:button")).click();
		return newPage(OutcomePage.class);
	}
