...
@PageURL("/exceptionhandler/handlednavigationmapping")
public class HandledNavigationMappingPage extends AbstractHandledExceptionPage {

	public HandledNavigationMappingPage(WebDriver webDriver) {
		super(webDriver);
	}
